...
export default function Mensajes() {
  ...
  // Mock users list - replace with real data from API
  ...
  // Handle user selection to start conversation
...
<cfdi:Comprobante xmlns:cfdi="http://www.sat.gob.mx/cfd/4">
  ...
  <cfdi:Total>11600.00</cfdi:Total>
      ...
      {isNewConversationModalOpen && (
        <div className={styles.modalOverlay} onClick={() => setIsNewConversationModalOpen(false)}>
          <div className={styles.modalContent} onClick={(e) => e.stopPropagation()} style={{ maxWidth: '500px' }}>
            <div className={styles.modalHeader}>
              <h3 className={styles.modalTitle}>Nueva conversación</h3>
              <div className={styles.modalActions}>
                <button 
                  className={styles.modalActionButton} 
                  title="Cerrar"
                  ...
                  filteredUsers.map((user) => (
                    ...
                    >
                      <div className={styles.userAvatar}>
                        ...
                        <div className={`${styles.userStatusIndicator} ${styles[`userStatus${user.status.charAt(0).toUpperCase() + user.status.slice(1)}`]}`}></div>
                      </div>
